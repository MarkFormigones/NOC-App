...
//{
//    public class OptionsLockupController : BaseController
//    {
//        //
//        // GET: /AppLockup/
...
//            DAL.DataManager dataMgr = new DAL.DataManager();
//            var pInfo = new DAL.OptionsLockup();
//            int adminId = -1;
//            if (rId == null || rId == -1)
//            {
...
//            else
//            {
//                pInfo = dataMgr.GetOptionsLockupInfoById(rId);
//            }


//            var pInfoM = new OptionsLockupModel(pInfo);
...
//        [HttpPost]
//        public ActionResult Define(OptionsLockupModel model)
//        {
...
//                    {
//                        bool isnew = true;
//                        var items = new DAL.OptionsLockup();
//                        DAL.DataManager dataMgr = new DAL.DataManager();
//                        if (model.Id > 0)
//                        {
//                            isnew = false;
//                            items = dataMgr.OptionsLockups.Where(x => x.Id == model.Id).SingleOrDefault();
//                        }

//                        items.OpValue = model.OpValue;
//                        items.OpText = model.OpText;
//                        items.OpClass = model.OpClass;
//                        items.OpClass2 = model.OpClass2;
//                        items.OpType = model.OpType;

//                        if (model.FromActionType == -1) { items.IsDeleted = true; } //Delete the Object
//                        items.IsActive = model.IsActive;

//                        if (isnew) { items.IsDeleted = false; dataMgr.OptionsLockups.Add(items); }//New Object
//                        dataMgr.SaveChanges();

//                        ViewBag.status = "Success";
//                        tempId = items.Id;
//                        if (isnew)
//                        { logMsg = "OptionsLockup Added-OK"; base.Logger(DAL.General.ActivityLokup.ACTIVITY, DAL.General.OperationLokup.ADDNEW, DAL.General.ActionCommandReq.Default,logMsg, tempId, -1, -1, -1,-1,-1,-1,-1,-1); }
//                        else
//                        { logMsg = "OptionsLockup Updated-OK"; base.Logger(DAL.General.ActivityLokup.ACTIVITY, DAL.General.OperationLokup.UPDATE, DAL.General.ActionCommandReq.Default,logMsg, tempId, -1, -1, -1,-1,-1,-1,-1,-1); }
...
//            return RedirectToAction("define", "OptionsLockup", new { rid = tempId });
//        }
...
//                        DAL.DataManager dataMgr = new DAL.DataManager();
//                        var items = dataMgr.OptionsLockups.Where(x => x.Id == rid).SingleOrDefault();

//                        items.IsDeleted = true;  //Delete the Object   
//                        items.IsActive = false;                  
//                        dataMgr.SaveChanges();
//                        ViewBag.status = "Deleted";
//                        logMsg = "OptionsLockup Deleted-OK";
...
//                        logMsg = "OptionsLockup Deleted-ERR";
//                        ModelState.AddModelError("error", e.Message);
...
//                base.SetOperationCompleted("info", "Operation", logMsg);
//            }
//            return RedirectToAction("OptionsLockupList", "OptionsLockup");
//        }
...
//        public ViewResult OptionsLockupList()
//        {
//            DAL.DataManager dataMgr = new DAL.DataManager();
//            var items = dataMgr.GetOptionsLockup_List();
//            var Roleitems = dataMgr.GetUser_Roles();
//            var ls_items = new List<Models.Definitions.OptionsLockupModel>();
//            foreach (var item in items)
//            {
//                var l_item = new Models.Definitions.OptionsLockupModel();
//                l_item.Id = item.Id;
//                l_item.OpValue = item.OpValue;
//                l_item.OpText = item.OpText;
//                l_item.OpClass = item.OpClass;
//                l_item.OpClass2 = item.OpClass2;
//                l_item.OpType = item.OpType;
