    ...
    return {
        ...
        init: function () {
            ...
            var treeDataSource4 = new DataSourceTree({
                data: [
                    { name: '<i class="fa fa-case"></i>Entity<div class="tree-actions"><i class="fa fa-plus"></i><i class="fa fa-trash-o"></i><i class="fa fa-refresh"></i></div>', type: 'folder', additionalParameters: { id: 'F11' } },
                    { name: '<i class="fa fa-case"></i>Unit<div class="tree-actions"><i class="fa fa-plus"></i><i class="fa fa-trash-o"></i><i class="fa fa-refresh"></i></div>', type: 'folder', additionalParameters: { id: 'F12' } },
                    { name: '<i class="fa fa-gear"></i> Process <div class="tree-actions"><i class="fa fa-plus"></i><i class="fa fa-trash-o"></i><i class="fa fa-refresh"></i></div><div class="tree-actions"><i class="fa fa-plus"></i><i class="fa fa-trash-o"></i><i class="fa fa-refresh"></i></div>', type: 'item', additionalParameters: { id: 'I11' } },
            ...
            var treeDataSource7 = new DataSourceTree({
                data:    $.get("/BDivisions/_subTree", function (data1) {
                    debugger;
                    data = data1;}),
                delay: 400
            });
